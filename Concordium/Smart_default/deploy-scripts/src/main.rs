...
async fn main() -> Result<(), Error> {
    ...
    let init_method_name: &str = "init_three_signs"; // Example
    ...
    use three_signs::MyInputType; // Example
    ...
    let update_payload = transactions::UpdateContractPayload {
        ...
        receive_name: OwnedReceiveName::new_unchecked("three_signs.receive".to_string()),
